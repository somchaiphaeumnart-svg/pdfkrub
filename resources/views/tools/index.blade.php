...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="mb-12 text-center">
        <h1 class="text-4xl font-bold text-white mb-3">เครื่องมือ PDF ทั้งหมด</h1>
        <p class="text-slate-400">ครบครัน 50+ รายการ รองรับภาษาไทย 100%</p>
    </div>
    ...
    <div class="mb-14">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            ...
            <a href="{{ route('tools.'.$tool['slug']) }}" class="tool-card group relative">
                ...
                <h3 class="text-sm font-semibold text-white group-hover:text-brand-400 transition-colors leading-tight">
                    {{ $tool['name_th'] }}
                </h3>
                <p class="text-xs text-slate-500 mt-1 line-clamp-2 leading-relaxed">{{ $tool['description_th'] }}</p>
            </a>
            @endforeach
        </div>
    </div>
