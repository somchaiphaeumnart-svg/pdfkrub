    ...
    <div class="glass rounded-3xl p-8 sm:p-12 border border-white/[0.08] space-y-8 text-slate-300 leading-relaxed text-sm">
        ...
        <section class="space-y-3">
            ...
            <ul class="list-disc list-inside space-y-1 pl-2 text-slate-400">
                <li><strong class="text-white">ข้อมูลบัญชีผู้ใช้:</strong> ชื่อ นามสกุล ที่อยู่อีเมล และรหัสผ่านที่เข้ารหัสแล้ว (เมื่อสมัครสมาชิก)</li>
                <li><strong class="text-white">ข้อมูลการชำระเงิน:</strong> ข้อมูลการสั่งซื้อผ่าน Omise Gateway (เราไม่เก็บเลขบัตรเครดิตฉบับเต็มบนเซิร์ฟเวอร์ของเรา)</li>
                <li><strong class="text-white">ไฟล์เอกสารที่อัปโหลด:</strong> เพื่อดำเนินการแปลง แก้ไข หรือประมวลผลตามคำสั่งของท่าน</li>
                <li><strong class="text-white">ข้อมูลเชิงเทคนิค:</strong> ที่อยู่ IP, ชนิดของเบราว์เซอร์ และบันทึกเวลาการเข้าถึง เพื่อความปลอดภัยของระบบ</li>
            </ul>
        </section>
        ...
        <section class="space-y-3">
            ...
            <p>
                PDFkrub มีนโยบาย <strong class="text-white">ไม่เก็บรักษาไฟล์เอกสารของท่านเกินความจำเป็น</strong> โดยไฟล์เอกสารที่อัปโหลดจะถูกลบทำลายอย่างถาวรจากเซิร์ฟเวอร์โดยอัตโนมัติ:
            </p>
            <ul class="list-disc list-inside space-y-1 pl-2 text-slate-400">
